...
- What shipped in the v1.3.0 package set.
- Which bridge and enterprise integration items were validated.
- Which historical publishing notes were superseded by the v2.0.0 release process.
