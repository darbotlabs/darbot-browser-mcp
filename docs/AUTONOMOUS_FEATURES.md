...
This document outlines the autonomous browser for Darbot Browser, implementing the vision for intelligent, memory-driven web crawling.
...
- `maxDepth`: Maximum crawl depth (1-100)
