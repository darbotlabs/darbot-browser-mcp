...
test('--device should work', async ({ startClient, server, mcpMode, mcpBrowser, mcpHeadless }) => {
  ...
  test.skip(mcpBrowser === 'msedge' && mcpHeadless, 'Headless Edge does not support launchPersistentContext with device emulation');
