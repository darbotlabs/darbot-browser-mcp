...
// @ts-check
/**
 * Demonstrates opening the DarbotLabs VS Code publisher page or a supplied URL.
 * Run from the repository root:
 *   node examples/open-marketplace.js [url]
 */
...
async function main() {
  ...
  const client = new Client({ name: 'darbot-open-marketplace', version: '2.0.0' });
